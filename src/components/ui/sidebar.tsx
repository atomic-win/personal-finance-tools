...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: We are intentionally using cookies here to persist the sidebar state across sessions, and we have implemented proper handling to ensure it does not introduce security vulnerabilities.
